	...
	{		
		...
		*/ 
		...
		private function setSrcPosList2Cols(numLe:uint, numRi:uint):void {   				
			...
			var boxH: uint = (Assets.IMG_NUMBER_HEIGHT + 64);        //remove the fixed 32 pixels of HUD buttons 							
		...
		private function setSrcPosList4Cols(numLe1:uint, numLe2:uint, numRi1:uint, numRi2:uint):void {   
			...
			var xri1:uint = boxW + Assets.IMG_NUMBER_WIDTH + boxW * 0.3 - boxAdjW; 
			var xri2:uint = boxW + Assets.IMG_NUMBER_WIDTH + boxW * 0.7 - boxAdjW; 
