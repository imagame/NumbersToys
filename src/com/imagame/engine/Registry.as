package com.imagame.engine 
{
	 ...
	 public class Registry
	{
		...
		static public var GAME_VERSION: String = "1.2.0"; //[iOS]	Versión compatible con 64bits (necesario para ejecución en iOS 11)
		
		//[ANDROID]
		//static public var IMAENGINE_VERSION: String = "1.11";
		//static public var GAME_VERSION: String = "1.1.0"; //[ANDROID]	//Change of engine version, new AdMob ANE, and url link to Store 
		...
		//[TEST]
		static public var bAd: Boolean = true;		//Advertising support
