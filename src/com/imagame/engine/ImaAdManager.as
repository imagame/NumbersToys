package com.imagame.engine 
{
	...
	*/
	...
	public class ImaAdManager 
	{
		...
		public function ImaAdManager(stage: Stage) 			
		{						
			//AdMob id
		...
		*/
		...
		public function initAds():void {//funcBanCB: Function, funcIntCB: Function, funcIntEndCB: Function):void {
			/* Option 0
			if (bAdProvider) 
			{
			...
			*/
			...
			if (bAdProvider) {
				...
				//if(Registry.gameRect.width >= 1200)
					//admob.showBanner( Admob.IAB_BANNER, AdmobPosition.BOTTOM_CENTER); //no compatible con última v de ane
					admob.showBanner(AdmobSize.BANNER_468X60, AdmobPosition.BOTTOM_CENTER);
				else
					//admob.showBanner( Admob.BANNER, AdmobPosition.BOTTOM_CENTER); //Banner para Pantalla 800x600 //no compatible con última v de ane
