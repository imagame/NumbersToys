package net.hires.debug 
{
	...
	public class MovieMonitor extends Sprite {
		...
		private var _stage: Stage = Registry.stage;
		...
		private function update(e:Event):void {
			...
			if (timer-1000>lastTimeCheck) {
				...
				xml.framesPerSecond=fps+" / "+_stage.frameRate;
				xml.widthPx=_stage.width+" / "+_stage.stageWidth;
				xml.heightPx=_stage.height+" / "+_stage.stageHeight;
				childrenCount=0;
				countDisplayList(_stage);
