...
:: Android packaging
set AND_CERT_NAME="NumbersToys"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\ios_dev_imagame.p12
...
set IOS_PROVISION=cert\NumbersToys_App_Store_Submission_3.mobileprovision
::set IOS_PROVISION=cert\NumbersToys_Dev17.mobileprovision
...
set APP_ID=com.imagame.numberstoys

:: Output packages
set DIST_PATH=dist
set DIST_NAME=NumbersToys
